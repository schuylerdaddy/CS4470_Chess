namespace ShallowRed
{
        ...
        static public void AddPawnMoves(this char[] board, bool white, int i, ref List<char[]> moves)
        {
            ...
            if (!white)
            {
                if (i / 9 == 1)
                {
                    ...
                    {
                        temp = board.MovePawn(i, i + 18, false);
                        if (!temp.InCheck(white))
                            moves.Add(temp);
                    }   
                }
                ...
                if (board[i + 9] == '_')
                {
                    temp = board.MovePawn(i, i + 9, false);
                    if (!temp.InCheck(white))
                        moves.Add(temp);
                }
                if(Char.IsUpper(board[i+8]))
                {
                    temp = board.MovePawn(i, i + 8, false);
                    if (!temp.InCheck(white))
                        moves.Add(temp);
                }
                if (i < 61 && Char.IsUpper(board[i + 10]))
                {
                    temp = board.MovePawn(i, i + 10, false);
                    if (!temp.InCheck(white))
                        moves.Add(temp);
                }
            }
    ...
    {
        static public List<char[]> GetLegalMoves(char[] board, ChessColor color)
        {
        ...
        static public void AddAdjacentMaps(char[] board, bool white, int i, ref List<char[]> moves)
        {
            int idx = i + 9;
            while (idx < 71)
            {
        ...
        static public void AddDiagonalMaps(char[] board, bool white, int i, ref List<char[]> moves)
        {
            int idx = i + 8;
            while (idx < 71 && idx % 9 >= 0)
            {
        ...
        static public void AddKnightMoves(char[] board, bool white, int i, ref List<char[]> moves)
        {
            int originRow = i % 9;
            int idx = i + 19;
        ...
        static public void AddKingMoves(char[] board, bool white, int i, ref List<char[]> moves)
        {
            char[] temp;
        ...
        static public void AddPawnMoves(char[] board, bool white, int i, ref List<char[]> moves)
        {
            if (!white)
            {
                if (i / 9 == 1)
